...
export default function AdminOrdersPage() {
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-6 md:py-8" dir="rtl">
      <section className="overflow-hidden rounded-3xl bg-linear-to-l from-red-600 via-red-500 to-orange-500 p-6 text-white shadow-lg md:p-8">
        <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 xl:grid-cols-6">
            <MiniStat label="کل سفارش‌ها" value={stats.total} />
            <MiniStat label="در انتظار" value={stats.pending} />
            <MiniStat label="پردازش" value={stats.processing} />
            <MiniStat label="ارسال‌شده" value={stats.shipped} />
            <MiniStat label="تحویل‌شده" value={stats.delivered} />
            <MiniStat
              label="مجموع فروش"
      ...
      <section className="mt-6 rounded-3xl border border-neutral-200 bg-white p-4 shadow-sm md:p-5">
